        ...
        <div className="container mx-auto px-6 lg:px-[8vw] max-w-[1800px]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-16 mb-24">
            ...
            <div className="space-y-6">
              <button onClick={onHomeClick} className="block text-2xl font-light text-gray-300 hover:text-white transition-colors text-left">About Vedartha</button>
            ...
            <div>
              ...
              <ul className="space-y-5 text-gray-400 text-sm font-medium">
                ...
                <li><a href="#" className="text-white hover:text-[#86BC25] transition-colors border-b-2 border-[#86BC25] pb-1">Vedartha Insights</a></li>
