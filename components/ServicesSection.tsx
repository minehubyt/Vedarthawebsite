...
const ServicesSection: React.FC = () => {
  ...
  return (
    <section className="bg-white relative overflow-hidden">
      ...
      >
        <span className="text-[clamp(10rem,25vw,35rem)] font-black leading-none uppercase tracking-tighter">
          Solutions. Impact. Future.
        </span>
      </motion.div>

      <div className="py-[clamp(5rem,12vw,12rem)] relative z-10">
        <div className="container mx-auto px-6 lg:px-[8vw] max-w-[1800px]">
          
          <div className="flex flex-col lg:flex-row gap-12 sm:gap-24 mb-20 sm:mb-32 items-start">
            <motion.div 
              ...
              className="lg:w-1/2"
            >
              <span className="text-[#86BC25] font-bold uppercase tracking-[0.4em] text-[10px] sm:text-[12px] mb-6 sm:mb-8 block">
                Expertise & Capabilities
              </span>
              <h2 className="text-[clamp(2.5rem,8vw,6.5rem)] font-black mb-8 sm:mb-10 leading-[0.95] tracking-tighter text-black">
                Redefining the <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#86BC25] to-green-300">impossible.</span>
              </h2>
              <p className="text-[clamp(1.1rem,1.5vw,1.6rem)] text-gray-500 max-w-xl font-light leading-relaxed">
            ...
            <div className="lg:w-1/2 w-full lg:pt-12">
               <div className="space-y-8 sm:space-y-12">
                  {['Digital Transformation', 'Strategic Growth', 'Sustainable Impact'].map((item, i) => (
                    <motion.div 
                      ...
                      className="group flex items-center justify-between border-b border-gray-100 pb-6 sm:pb-8 cursor-pointer"
                    >
                      <div className="flex items-center space-x-6 sm:space-x-8">
                        <span className="text-gray-300 font-black text-xl sm:text-2xl group-hover:text-[#86BC25] transition-colors">0{i+1}</span>
                        <h3 className="text-2xl sm:text-3xl font-bold tracking-tight group-hover:translate-x-4 transition-transform duration-500">{item}</h3>
                      </div>
                      <ArrowUpRight className="text-gray-200 group-hover:text-[#86BC25] group-hover:rotate-45 transition-all duration-500" size={28} />
                    </motion.div>
                  ))}
               </div>
            </div>
            ...
            {SERVICES.map((service, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative h-[450px] sm:h-[600px] overflow-hidden rounded-sm bg-gray-50 cursor-pointer"
                >
                  ...
                  <div className="absolute inset-0 z-10 p-8 sm:p-12 flex flex-col justify-between">
                    <div>
                      <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-white flex items-center justify-center shadow-lg group-hover:bg-[#86BC25] group-hover:text-white transition-all duration-500 mb-8 sm:mb-12">
                        <IconComp size={28} className="group-hover:scale-110 transition-transform duration-500" />
                      </div>
                      <h4 className="text-2xl sm:text-3xl font-black mb-4 sm:mb-6 tracking-tighter group-hover:text-white transition-colors">
                      ...
                      <p className="text-gray-500 group-hover:text-gray-100 text-base sm:text-lg font-light leading-relaxed opacity-0 group-hover:opacity-100 translate-y-10 group-hover:translate-y-0 transition-all duration-700">
                        {service.description}
                      </p>
                    </div>

                    <div className="flex items-center justify-between text-black group-hover:text-white transition-colors border-t border-gray-100 group-hover:border-white/20 pt-6 sm:pt-8 mt-8">
                      <span className="text-[10px] sm:text-xs font-bold uppercase tracking-[0.3em]">Explore</span>
