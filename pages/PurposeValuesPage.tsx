...
const SHARED_VALUES = [
  {
    ...
    icon: 'https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&q=80&w=100'
  },
  {
    ...
    icon: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&q=80&w=100'
  },
  {
    ...
    icon: 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=100'
  },
  {
    ...
    icon: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&q=80&w=100'
  },
  {
    ...
    icon: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80&w=100'
  }
];
...
const PurposeValuesPage: React.FC = () => {
  return (
    <div className="bg-white min-h-screen">
        ...
        <div className="container mx-auto px-6 lg:px-[8vw] max-w-[1600px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {SHARED_VALUES.map((value, idx) => (
              ...
              >
                <div className="mb-10 w-24 h-24 overflow-hidden rounded-full">
                  <img src={value.icon} alt={value.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                </div>
      ...
      <section className="relative overflow-hidden py-32 bg-black text-white text-center">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-8">
              ...
              <button className="border border-white/20 text-white hover:bg-white hover:text-black px-12 py-4 rounded-full font-bold text-[14px] uppercase tracking-widest transition-all">
                Learn about Vedartha WorldClass
              </button>
            </div>
          </div>
        </div>
