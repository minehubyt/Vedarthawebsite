...
const LEGAL_SECTIONS = [
  ...
  },
  {
    ...
    description: 'Specific legal notices and information for individuals applying for careers at Vedartha.',
    href: '#'
  },
  {
    ...
    <div className="pt-24 pb-32 bg-white">
      <div className="container mx-auto px-6 lg:px-[8vw] max-w-[1800px]">
        ...
        <nav className="flex items-center space-x-2 text-[12px] font-bold text-gray-500 uppercase tracking-widest mb-12">
          <a href="#" className="hover:text-[#86BC25] transition-colors">Home</a>
        ...
        >
          ...
          <p className="text-2xl text-gray-500 font-light max-w-3xl leading-relaxed">
            Vedartha International Limited is committed to transparency and upholding the highest legal and ethical standards in all our operations globally.
          </p>
        </motion.div>
          ...
          {LEGAL_SECTIONS.map((section, index) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <h3 className="text-2xl font-bold group-hover:text-[#86BC25] transition-colors duration-300">
                  {section.title}
                </h3>
                <ChevronRight className="text-gray-300 group-hover:text-[#86BC25] group-hover:translate-x-1 transition-all" size={24} />
              </div>
              <p className="text-gray-500 font-light leading-relaxed mb-6">
                {section.description}
              </p>
              <div className="flex items-center text-xs font-bold uppercase tracking-widest text-black group-hover:text-[#86BC25] transition-colors">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="mt-24 p-12 bg-gray-50 rounded-sm border-l-8 border-[#86BC25]"
        >
          ...
          <button className="bg-black text-white hover:bg-[#86BC25] hover:text-white px-8 py-4 rounded-full font-bold text-sm transition-all shadow-lg">
